package com.example.particleapped.ui.particleAppScreen.homescreen
...
import com.example.particleapped.data.Payment
import com.example.particleapped.utils.Network
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = "Amount: $amount CFX",
                )
                Spacer(modifier = Modifier.width(8.dp))
                Image(
                    painter = rememberAsyncImagePainter(model = ChainInfo.ConfluxeSpaceTestnet.icon),
                    contentDescription = "cfx Logo",
